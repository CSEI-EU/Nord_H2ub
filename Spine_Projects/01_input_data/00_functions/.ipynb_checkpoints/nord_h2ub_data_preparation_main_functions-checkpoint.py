...
def set_parameters(params):
    ...
    default_params = {
        ...
        'inv_cost_rwgs': None,
        'inv_cost_steam': None,
        'capacity_ammonia_storage': None,
        'capacity_anaerobic': None,
        'capacity_asu': None,
        'capacity_biomethanation': None,
        'capacity_co2_removal': None,
        'capacity_distillation': None,
        'capacity_egasoline_storage': None,
        'capacity_electrolyzer': None,
        'capacity_fischer': None,
        'capacity_haber': None,
        'capacity_hydrogen_storage': None,
        'capacity_jet_fuel_storage': None,
        'capacity_methane_storage': None,        
        'capacity_methanol': None,
        'capacity_methanol_storage': None,
        'capacity_rwgs': None,
        'capacity_steam': None,
