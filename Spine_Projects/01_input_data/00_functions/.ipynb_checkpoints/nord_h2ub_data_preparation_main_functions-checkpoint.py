...
def set_parameters(params):
    ...
    default_params = {
        ...
        'inv_cost_rwgs': None,
        'inv_cost_steam': None,
        'capacity_ammonia_storage': 1000,
        'capacity_anaerobic': 100,
        'capacity_asu': 100,
        'capacity_biomethanation': 100,
        'capacity_co2_removal': 100,
        'capacity_distillation': 100,
        'capacity_egasoline_storage': 1000,
        'capacity_electrolyzer': 100,
        'capacity_fischer': 100,
        'capacity_haber': 100,
        'capacity_hydrogen_storage': 1000,
        'capacity_jet_fuel_storage': 1000,
        'capacity_methane_storage': 1000,        
        'capacity_methanol': 100,
        'capacity_methanol_storage': 1000,
        'capacity_rwgs': 100,
        'capacity_steam': 100,
