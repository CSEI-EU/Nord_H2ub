...
#Graph
{
  ...
  plot = ggplot(lcoe, aes(x = number, group = 1)) +
    ...
    geom_point(aes(y = LCOE_Euro_t), color = "#6793D6", size = 3) +
    geom_line(aes(y = 0.9995*min.lcoe + coeff  * hours), color = "#242E70", linewidth = 1) +
    geom_point(aes(y = 0.9995*min.lcoe + coeff  * hours), color = "#242E70", size = 3) +
    scale_x_continuous(
    ...
    theme(
      ...
      axis.title.y.right = element_text(color = "#242E70", size = 12, face = "bold"),
      axis.text.y.right = element_text(color = "#242E70", face = "bold"),
